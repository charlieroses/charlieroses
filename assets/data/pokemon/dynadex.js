...
function getPkmnImageSrc( di ) {
	...
	return assetsbase + "images/pokemon/dex/" + dir + "/" + imgdi + ".png";
}
...
function isMega( di ) {
	...
	if( ! getPkmnField(di,"form-data") )
		return false;
	field = getPkmnField(di,"form-data");
	if( ! field["type"] )
		return false;
...
function getPkmnTypeAdvantage( di ) {
	let		adv;
	let		types, i, j;
...
function getPkmnMoveset( di, fc, sea ) {
	...
	if( fc == "dynamax" )
		return getPkmnMaxAttacksMoveset( di, sea );
...
function getPkmnMaxAttacksMoveset( di, sea ) {
	if( crownCheck(di) )
		return crownMaxAttacksMoveset(di);
	return Array.from(new Set(getPkmnMoveset(di,"fast",sea).map((f) => getMaxMoveFromFast(f))));
}

function crownCheck( di ) {
	return ( di == "888-C" || di == "889-C" );
}
function crownMaxAttacksMoveset( di ) {
	return [ "DYNA_" + di ];
}
...
const	dbpokemon = {
	"entries": {
		...
		"128-C": {
			...
			"type": [ "Fighting" ],
			"weight-avg": 115,
			"wt-std-dev": 14.375, // TODO figure out how to handle that with size ranges
			"charged-attacks": [
				"CHRG_FIG_CLOSECOMBAT",
				"CHRG_GRA_TRAILBLAZE",
				"CHRG_GRO_EARTHQUAKE",
		...
		"128-B": {
			...
			"type": [ "Fighting", "Fire" ],
			"weight-avg": 85,
			"wt-std-dev": 10.625, // TODO figure out how to handle that with size ranges
			"charged-attacks": [
				"CHRG_FIR_FLAMECHARGE",
				"CHRG_GRA_TRAILBLAZE",
				"CHRG_GRO_EARTHQUAKE",
		...
		"128-A": {
			...
			"type": [ "Fighting", "Water" ],
			"weight-avg": 110,
			"wt-std-dev": 13.75, // TODO figure out how to handle that with size ranges
			"charged-attacks": [
				"CHRG_FIR_AQUAJET",
				"CHRG_GRA_TRAILBLAZE",
				"CHRG_GRO_EARTHQUAKE",
		...
		"213": {
			...
			"base-defense": 396,
			"dynamax-class": 2,
			"max-battle-tier": 2, // 3 star guess was wrong
			"fast-moves": [
				"FAST_BUG_STRUGGLEBUG",
				"FAST_ROC_ROCKTHROW"
			],
		...
		"479": {
			...
			"category": "Plasma",
			"type": [ "Electric", "Ghost" ],
			"forms": [ "479-H", "479-W", "479-M", "479-V", "479-G" ],
			"base-stamina": 137,
			"base-attack": 185,
			"base-defense": 159,
			"dynamax-class": 3,
		...
		"493": {
			...
			"type": [ "Normal" ],
			"forms": [
				"493-BUG", "493-DAR", "493-DRA",
				"493-ELE", "493-FAI", "493-FIG",
				"493-FIR", "493-FLY", "493-GHO",
				"493-GRA", "493-GRO", "493-ICE",
				"493-POI", "493-PSY", "493-ROC",
				"493-STE", "493-WAT"
			],
			"base-stamina": 237,
			"base-attack": 238,
...
//			}
		...
		"669-0": {
			...
			"type": [ "Fairy" ],
			"forms": [ "669-B", "669-O", "669-R", "669-W", "669-Y" ],
			"evolves-into": [ "670-0" ],
			"base-stamina": 127,
			"base-attack": 108,
			"base-defense": 120,
		...
		"670-0": {
			...
			"category": "Single Bloom",
			"type": [ "Fairy" ],
			"forms": [ "670-B", "670-O", "670-R", "670-W", "670-Y" ],
			"evolves-from": "669-0",
			"evolves-into": [ "671-0" ],
			"base-stamina": 144,
			"base-attack": 136,
		...
		"671-0": {
			...
			"category": "Garden",
			"type": [ "Fairy" ],
			"forms": [ "671-B", "671-O", "671-R", "671-W", "671-Y" ],
			"evolves-from": "670-0",
			"base-stamina": 186,
			"base-attack": 212,
			"base-defense": 244,
...
//			"weight-avg": 262.4
		...
		"745-0": {
			...
			"category": "Wolf",
			"type": [ "Rock" ],
			"forms": [ "745-D", "745-N", "745-S" ],
			"evolves-from": "744",
			"dynamax-class": 2,
			"size-calc-ignore": true,
			"showcase-baseline": "745-D"
		},
		"745-D": {
			"dex-index": "745-D",
			"form-data": {
		...
		"766": {
			...
			"base-defense": 160,
			"dynamax-class": 3,
			"max-battle-tier": 3, // TODO confirm prediction
			"fast-moves": [
				"FAST_FIG_COUNTER",
				"FAST_FIG_ROCKSMASH",
				"FAST_NOR_TAKEDOWN"
		...
		"773": {
			...
			"type": [ "Normal" ],
			"forms": [
				"773-BUG", "773-DAR", "773-DRA",
				"773-ELE", "773-FAI", "773-FIG",
				"773-FIR", "773-FLY", "773-GHO",
				"773-GRA", "773-GRO", "773-ICE",
				"773-POI", "773-PSY", "773-ROC",
				"773-STE", "773-WAT"
			],
			"evolves-from": "772",
			"base-stamina": 216,
		...
		"890": {
			...
			"name": "Eternatus",
			"availability": {
				"in-game": "2025-08-23" // TODO Unconfirmed
			},
			"category": "Gigantic",
			"legendary": true,
			"type": [ "Poison", "Dragon" ],
		...
		"892-0": {
			...
			"legendary": true,
			"type": [ "Fighting", "Dark" ],
			"forms": [ "891-S", "891-R", "891-SG", "891-RG" ],
			"evolves-from": "891",
			"base-stamina": 225,
			"base-attack": 254,
			"base-defense": 177,
		...
		"1017-0": {
			...
			"legendary": true,
			"type": [ "Grass" ],
			"forms": [ "1017-T", "1017-W", "1017-H", "1017-C" ],
			"height-avg": 1.2,
			"weight-avg": 39.8,
			"size-calc-ignore": false
		},
	...
	"order": [
		...
		"475", "475-M",
		"476", "477", "478",
		"479", "479-H", "479-W", "479-G", "479-V", "479-M",
		"480", "481", "482",
		"483", "483-O", "484", "484-O",
		"485", "486",
		"487-0", "487-A", "487-O",
